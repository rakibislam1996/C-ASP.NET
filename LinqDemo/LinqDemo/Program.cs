...
namespace LinqDemo
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var findBooks = books.Where(book => book.Price >= 7000 && book.PublishDate > new DateTime(2010, 1, 1));
            //foreach (var item in findBooks)
            //    Console.WriteLine(item.Name);
            //Console.WriteLine();

            var findBooks2 = from book in books
            ...
            var selectBook2 = from book in books
            ...
            //var findName = names.FindAll(name => name.StartsWith("R"));
            //foreach (var item in findName)
            //    Console.Write(item + " ");
            //Console.WriteLine("\n");

            var findName2 = from name in names
            ...
            //var findNum = numbers.FindAll(number => number >= 20);
            //foreach (var item in findNum)
            //    Console.Write(item + " ");
            //Console.WriteLine("\n");

            var findNum2 = from number in numbers
                           where number >= 20
                           select number;
